...
export const CATEGORIES: Record<WasteCategoryId, WasteCategory> = {
  ...
  food: {
    ...
    guidance:
      'Cho vào thùng chất thải thực phẩm, ủ phân hoặc xử lý theo quy định địa phương. Không trộn chung với đồ tái chế.',
    accessibilityLabel: 'Nhóm chất thải thực phẩm.',
  },
  other: {
    id: 'other',
    label: 'Chất thải khác',
    title: 'Chất thải khác',
    emoji: '🗑️',
    color: '#9CA3AF',
    softBg: 'rgba(156,163,175,0.14)',
    guidance:
      'Bỏ vào thùng chất thải thông thường theo quy định của địa phương.',
    accessibilityLabel: 'Nhóm chất thải khác, không thuộc các nhóm còn lại.',
  },
  hazardous: {
    id: 'hazardous',
    ...
    guidance:
      'Không bỏ chung với chất thải sinh hoạt. Đưa đến điểm thu gom chất thải nguy hại gần nhất.',
    warningNote:
      'Ưu tiên cảnh báo nguy hại. Vui lòng liên hệ đơn vị thu gom của địa phương để được hướng dẫn xử lý.',
    accessibilityLabel: 'Cảnh báo. Nhóm chất thải nguy hại, tuyệt đối không bỏ chung với chất thải sinh hoạt.'
  },
};
