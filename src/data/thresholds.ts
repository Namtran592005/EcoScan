 ...
 * analysed frames.
 */
export const CLASSIFY_SMOOTHING_WINDOW = 5;
export const CLASSIFY_CONFIRM_STREAK = 4;

/** After this many analysed frames without a stable result, show "Không chắc chắn". */
export const CLASSIFY_UNCERTAIN_AFTER_FRAMES = 10;

/** Minimum confidence (0..1) for a detected box to be drawn. */
export const DETECT_CONFIDENCE_THRESHOLD = 0.45;
 ...
 */
export const TARGET_INFER_FPS = 3;
